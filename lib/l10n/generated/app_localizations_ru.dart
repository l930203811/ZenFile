...
class L10nRu extends L10n {
  ...
  @override
  String get apk_open_mode_desc => 'Использовать системный выборщик для открытия APK, чтобы сторонние установщики вроде InstallerX могли их обрабатывать; при выключении используется встроенный установщик.';
  ...
  @override
  String get cl211_feat_1 => 'Собственное изображение как значок приложения: Настройки → Внешний вид и тема → Значок приложения. После выбора изображения его можно добавить на главный экран как ярлык или как виджет 1×1. Также исправлен случай, когда сообщалось «добавлено», но на деле ничего не добавлялось; если ваш лаунчер блокирует ярлыки, используйте виджет.';

  @override
  String get cl211_feat_2 => 'Подтверждение удаления теперь можно отключить: в диалоге удаления есть флажок «Больше не спрашивать», а в Настройки → Файловые операции и просмотр добавлён переключатель «Подтверждать перед удалением».';

  @override
  String get cl211_ui => 'Интерфейс и взаимодействие';

  @override
  String get cl211_ui_1 => 'Все диалоги прогресса теперь используют двойное кольцо: внешнее — для общего прогресса, внутреннее зелёное — для текущего файла. Охватывает копирование/вырезание, сжатие/распаковку, шифрование/расшифровку, импорт и восстановление хранилища, и резервное копирование по категориям.';

  @override
  String get cl211_ui_2 => 'Элементы управления воспроизведением видео стали меньше и опущены вниз прямо над полосой прогресса, поэтому больше не закрывают центр кадра.';

  @override
  String get cl211_ui_3 => 'В списке шифрования на месте хранилища появилось действие «Удалить» — оно лишь скрывает запись, зашифрованный файл на диске не затрагивается.';
  ...
  @override
  String get cl212_feat_1 => 'Переключаемый способ открытия APK: в Настройки → Настройки установки APK добавлен «Способ открытия APK» для выбора между встроенным установщиком и системным выборщиком. При выборе системного выборщика ZenFile больше не перехватывает открытие APK, поэтому сторонние установщики вроде InstallerX и InstallWithOptions могут их обрабатывать — при пакетной установке больше не нужно долго нажимать и выбирать «Открыть с помощью» для каждого файла.';

  @override
  String get cl212_ui => 'Интерфейс и взаимодействие';

  @override
  String get cl212_ui_1 => 'Шире диапазон «Размер и интервал»: нижняя граница ползунка интервала между карточками расширена с 40% до -50%. При 0% границы карточек соприкасаются, а при отрицательных значениях границы соседних карточек накладываются в одну линию. Значение по умолчанию также изменено на 0% (новые установки сразу прижаты; у уже настроенных пользователей сохраняется прежнее значение).';

  @override
  String get cl212_ui_2 => 'Диалог пользовательских ярлыков: «Форма значка» и «Столбцов в строке» теперь выбираются из выпадающего списка вместо кнопок бок о бок, что делает раскладку компактнее.';

  @override
  String get cl212_fixes => 'Исправления';

  @override
  String get cl212_fix_1 => 'Разблокировка по отпечатку теперь выключена по умолчанию: после установки разблокировка по отпечатку в Настройки → Безопасность выключена, пока вы не включите её — биометрическая разблокировка больше не включается автоматически.';

  @override
  String get cl212_fix_2 => 'Исправлена невозможность повторно настроить API-ключ проверки APK: раньше после сохранения ключа выключение и повторное включение переключателя не открывало страницу настроек. Теперь страница открывается и по переключателю, и по нажатию на карточку.';

  @override
  String get cl212_fix_3 => 'Исправлена ошибка «недостаточно прав» при тихой установке даже при авторизованном Shizuku: путь Shizuku теперь устанавливает через системную сессию PackageInstaller вместо команды shell, которую некоторые системы запрещают; путь root больше не передаёт лишний флаг понижения версии.';

  @override
  String get cl211_fix_1 => 'Исправлен чёрный экран (только звук, нет изображения) при воспроизведении видео на некоторых устройствах, вызванный проблемой совместимости рендерера, появившейся в 1.1.42. Теперь используется универсально совместимый путь отрисовки, а при сбоях аппаратного декодирования воспроизведение автоматически переключается на программное.';

  @override
  String get cl211_fix_2 => 'Исправлено воспроизведение удалённого видео по SMB / FTP / SFTP, которое замирало каждые несколько секунд, и панель прогресса возвращалась в начало после перемотки.';

  @override
  String get cl211_fix_3 => 'Исправлено: FTP иногда очень долго открывал папку или возвращался на уровень вверх.';

  @override
  String get cl211_fix_4 => 'Исправлено зависание сжатия больших или многих файлов на 100 %: ZIP-сжатие теперь выполняется потоково по файлам, что резко снижает расход памяти, пока прогресс продолжается.';

  @override
  String get cl211_fix_5 => 'Исправлено отображение всех треков плеером как «FLAC • 24-bit»; теперь показывается реальный формат, а для lossless — фактическая битовая глубина.';

  @override
  String get cl211_fix_6 => 'Исправлено: после настройки хранилища или шифрования на месте незашифрованные файлы ошибочно запрашивали пароль хранилища.';

  @override
  String get cl211_fix_7 => 'Исправлены две ошибки сообщений хранилища: при неверном пароле ошибочно показывалось «сначала задайте мастер-пароль»; уведомления о результате шифрования/расшифровки оставались на китайском в некитайских локалях.';
