...
class L10nAr extends L10n {
  ...
  @override
  String get apk_open_mode_desc => 'استخدم منتقي النظام لفتح ملفات APK بحيث يمكن لأدوات التثبيت الخارجية مثل InstallerX التعامل معها؛ عند التعطيل يُستخدم المثبّت المدمج.';
  ...
  @override
  String get cl211_feat_1 => 'أيقونة تطبيق من صورتك الخاصة: الإعدادات → المظهر والسمة → أيقونة التطبيق. بعد اختيار صورة، يمكنك إضافتها إلى الشاشة الرئيسية كاختصار أو كأداة بحجم 1×1. وأصلحنا أيضاً حالة الإبلاغ بـ «تمت الإضافة» دون إضافة شيء؛ إن كان مشغّل الشاشة يمنع الاختصارات، استخدم الأداة.';

  @override
  String get cl211_feat_2 => 'أصبح بإمكانك تعطيل تأكيد الحذف: يوجد في نافذة الحذف خيار «لا تسأل مجدداً»، وفي الإعدادات → عمليات الملفات والعارضات يوجد مفتاح «تأكيد قبل الحذف».';

  @override
  String get cl211_ui => 'الواجهة والتفاعل';

  @override
  String get cl211_ui_1 => 'كل نوافذ التقدّم تستخدم الآن حلقة مزدوجة: الحلقة الخارجية للتقدّم الكلي والداخلية الخضراء للملف الحالي. تشمل النسخ/القص، والضغط/الفك، والتشفير/فك التشفير، واستيراد واستعادة الخزنة، والنسخ الاحتياطي حسب الفئة.';

  @override
  String get cl211_ui_2 => 'أزرار تشغيل الفيديو أصغر حجماً وأُسقطت للأسفل فوق شريط التقدّم مباشرةً، فلم تعد تغطي مركز الصورة.';

  @override
  String get cl211_ui_3 => 'حصلت قائمة التشفير الموضعي في الخزنة على إجراء «إزالة» — يخفي الإدخال فقط، ولا يتأثر الملف المشفّر على القرص.';
  ...
  @override
  String get cl212_feat_1 => 'طريقة فتح APK قابلة للتبديل: الإعدادات ← إعدادات تثبيت APK تضيف «طريقة فتح APK» للاختيار بين المثبّت المدمج ومنتقي النظام. عند استخدام منتقي النظام، لا يعترض ZenFile فتح ملفات APK، ما يتيح لأدوات تثبيت خارجية مثل InstallerX وInstallWithOptions معالجتها — دون الحاجة للضغط مطولاً على كل ملف لاختيار «فتح باستخدام» عند التثبيت بالجملة.';

  @override
  String get cl212_ui => 'الواجهة والتفاعل';

  @override
  String get cl212_ui_1 => 'نطاق أوسع لـ «الحجم والمسافات»: خُفّض الحد الأدنى لمنزلق المسافة بين البطاقات من 40% إلى -50%؛ عند 0% تلتصق حدود البطاقات، والقيم السالبة تجعل حدود البطاقات المتجاورة تتداخل في خط واحد. كما أصبحت القيمة الافتراضية 0% (التثبيتات الجديدة متلاصقة من البداية؛ وتبقى الإعدادات الحالية كما هي).';

  @override
  String get cl212_ui_2 => 'مربع حوار الاختصارات المخصصة: أصبح «شكل الأيقونة» و«الأعمدة لكل صف» قوائم منسدلة بدلاً من أزرار متجاورة، لتصميم أكثر إحكاماً.';

  @override
  String get cl212_fixes => 'إصلاحات';

  @override
  String get cl212_fix_1 => 'أصبح فتح بصمة الإصبع معطلاً افتراضياً: بعد التثبيت يبقى فتح البصمة في الإعدادات ← الأمان معطلاً حتى تقوم بتفعيله، فلا يُفعّل فتح البصمة تلقائياً بعد التثبيت أو الترقية.';

  @override
  String get cl212_fix_2 => 'إصلاح عدم إمكانية إعادة ضبط مفتاح API لفحص أمان APK: سابقاً، بعد حفظ المفتاح، كان إطفاء المفتاح وتشغيله مجدداً لا يفتح صفحة الإعدادات. الآن تُفتح الصفحة من المفتاح ومن النقر على البطاقة.';

  @override
  String get cl212_fix_3 => 'إصلاح خطأ «صلاحية غير كافية» في التثبيت الصامت رغم السماح بـ Shizuku: مسار Shizuku يثبّت الآن عبر جلسة PackageInstaller للنظام بدلاً من أمر shell المحظور على بعض الأنظمة؛ ولا يمرّ مسار root بعلامة تخفيض إصدار غير ضرورية.';

  @override
  String get cl211_fix_1 => 'أصلحنا الشاشة السوداء (صوت فقط بلا صورة) عند تشغيل الفيديو على بعض الأجهزة، بسبب مشكلة توافق في العارض وُرِدت في 1.1.42. يستخدم العرض الآن المسار المتوافق عالمياً، ويتحول تلقائياً إلى فك التشفير البرمجي عند فشل فك التشفير العتادي.';

  @override
  String get cl211_fix_2 => 'أصلحنا تشغيل الفيديو عن بُعد عبر SMB / FTP / SFTP الذي كان يتوقف كل بضع ثوانٍ، وارتداد شريط التقدّم إلى البداية بعد السعي.';

  @override
  String get cl211_fix_3 => 'أصلحنا بطء FTP أحياناً عند فتح مجلد أو العودة لمجلد أعلى.';

  @override
  String get cl211_fix_4 => 'أصلحنا توقّف ضغط الملفات الكبيرة أو الكثيرة عند 100%: أصبح ضغط ZIP تدفقياً ملفاً بملف، ما يقلل استخدام الذاكرة كثيراً مع استمرار التقدّم.';

  @override
  String get cl211_fix_5 => 'أصلحنا عرض مشغّل الموسيقى لكل المسارات كـ «FLAC • 24-bit»؛ يظهر الآن التنسيق الفعلي، مع عمق البت الفعلي للتنسيقات غير المفقودة.';

  @override
  String get cl211_fix_6 => 'أصلحنا طلب ملفات غير مشفّرة لكلمة مرور الخزنة بشكل خاطئ بعد إعداد الخزنة أو التشفير الموضعي.';

  @override
  String get cl211_fix_7 => 'أصلحنا خطأين في رسائل الخزنة: عند إدخال كلمة مرور خاطئة كان يظهر «عيّن كلمة المرور الرئيسية أولاً»؛ وبقيت إشعارات نتيجة التشفير/فك التشفير بالصينية في اللغات غير الصينية.';
