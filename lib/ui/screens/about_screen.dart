...
class AboutZenFileScreen extends StatelessWidget {
  ...
  Widget _buildV1127Changelog(BuildContext ctx, ThemeData theme) {
    final l10n = L10n.of(ctx);
    final textStyle = TextStyle(fontSize: 13.5, height: 1.6, color: theme.colorScheme.onSurface.withOpacity(0.85));
    final sectionStyle = TextStyle(fontSize: 13.5, height: 1.6, color: theme.colorScheme.primary, fontWeight: FontWeight.w600);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Container(
                ...
                child: Text('v1.1.27', style: TextStyle(color: theme.colorScheme.primary, fontSize: 13, fontWeight: FontWeight.bold, fontFamily: 'LexendDeca')),
              ),
              const SizedBox(width: 10),
              Text('2026-08-09', style: TextStyle(fontSize: 12, color: theme.colorScheme.onSurface.withOpacity(0.4))),
            ],
          ),
          gap(14),
          ...
          gap(4),
          bulletText(l10n.changelog_v1127_new_1),
          gap(6),
          bulletText(l10n.changelog_v1127_new_2),
          gap(6),
          bulletText(l10n.changelog_v1127_new_3),
          gap(14),

          // ── Optimizations ──
          Text(l10n.changelog_section_optimizations, style: sectionStyle),
          gap(4),
          bulletText(l10n.changelog_v1127_opt_1),
          gap(14),

          // ── Bug Fixes ──
          Text(l10n.changelog_section_fixes, style: sectionStyle),
          gap(4),
          bulletText(l10n.changelog_v1127_fix_1),
          gap(14),
