...
- **远程浏览页重构**：远程服务器浏览页全面采用本地浏览页统一架构，消除页面切换时的状态错乱问题
- **双窗格远程拖放**：支持本地与远程服务器双窗格模式下自由复制、剪切、拖放文件
- **远程文件操作统一**：远程文件的删除、重命名、创建文件夹等操作与本地体验完全一致
...
- **远程服务器支持：** 支持 FTP、SFTP、WebDAV、局域网/SMB 等多种远程连接方式，与本地浏览统一界面操作。
